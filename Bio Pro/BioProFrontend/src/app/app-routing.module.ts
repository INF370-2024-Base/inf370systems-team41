...
const routes: Routes = [
  ...
  { path: 'deliveries', component: DeliveriesComponent, canActivate: [RoleGuardService], data: { expectedRoles: ['Admin', 'Lab Manager',"Owner"] } },
  ...
  { path: 'test', component: TestingBackendComponent, canActivate: [RoleGuardService], data: { expectedRoles: ['Admin'] } },
